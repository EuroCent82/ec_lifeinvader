-- ec_lifeinvader — QBCore Demo-Daten (Config.fake = true)
...
('FAKE00001', 'Bennys Motorworks', 'Suche Mechaniker für Tuning-Werkstatt!',
...
('FAKE00002', 'Franklin Clinton', 'Verkauf: Sultan RS Vollgetunt!',
...
('FAKE00003', 'Vanilla Unicorn', 'LifeInvader Party im Vanilla Unicorn!',
...
('FAKE00004', 'Rosenberg & Partner', 'Biete Anwaltshilfe in allen Lebenslagen',
...
('FAKE00005', 'Anonym', 'Verlorener Ehering gesucht',
